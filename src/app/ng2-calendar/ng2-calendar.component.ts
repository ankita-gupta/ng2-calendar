...
@Component({
  selector: 'app-ng2-calendar',
  templateUrl: './ng2-calendar.component.html',
  styleUrls: ['./ng2-calendar.component.css']
})
export class Ng2CalendarComponent implements OnInit {

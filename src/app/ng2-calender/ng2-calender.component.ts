...
@Component({
  selector: 'app-ng2-calender',
  templateUrl: './ng2-calender.component.html',
  styleUrls: ['./ng2-calender.component.css']
})
export class Ng2CalenderComponent implements OnInit {
  ...
  public detailset:boolean=false;
  ...
  checkDate(date){
    ...
    if(this.detailset && dDateOnly>=todayDateOnly){
        return true;
      }
  }
